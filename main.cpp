...
int StartDataBase() {
    Connection conn;
    try {
        conn.connect("postgresql://danek:xui@localhost/danek");
      ...
      CREATE TABLE IF NOT EXISTS programs (
        ...
        {
            oss << "{\"";
            std::copy(shin.begin(), shin.end()-1,
        ...
        conn.execute(R"SQL(
          ...
          (14, 'first', $1, '#include <stdio.h> #include <stdlib.h> int main() { }',
